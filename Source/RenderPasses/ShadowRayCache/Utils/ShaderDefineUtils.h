...
static std::string getMipViewDefineString(const uint lightIndex, const uint mipCount)
{
    std::string s;
...
static std::string getFeedbackViewDefineString(const uint lightIndex, const uint standardMipCount)
{
